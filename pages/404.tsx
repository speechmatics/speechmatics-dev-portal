...
export default function Custom404() {
  return <div
    style={{ "color": "#000", "background": "#fff", "fontFamily": "-apple-system, BlinkMacSystemFont, Roboto, 'Segoe UI', 'Fira Sans', Avenir, 'Helvetica Neue', 'Lucida Grande', sans-serif", "height": "100vh", "textAlign": "center", "display": "flex", "flexDirection": "column", "alignItems": "center", "justifyContent": "center", "width": "100vw" }}
  >
